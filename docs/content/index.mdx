---
description: "chat-adapter-zaileys plugs WhatsApp into Chat SDK through Zaileys — real message history, native buttons from Cards, decrypted poll votes, scheduling, and rich media."
---
...
const bot = new Chat({ userName: 'mybot', adapters: { whatsapp }, state: memoryState() })
