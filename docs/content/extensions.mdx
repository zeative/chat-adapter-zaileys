---
description: "Every WhatsApp-native adapter extension — reply, markRead, presence, stickers, voice notes, locations, group participants — plus native(), the escape hatch to the full Zaileys builder."
---
...
```typescript
import { isZaileysAdapter, requireZaileysAdapter } from 'chat-adapter-zaileys'
