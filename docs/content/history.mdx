---
description: "Real WhatsApp message history through thread.fetchMessages — backed by the Zaileys message store with cursor pagination and media rehydration."
---
