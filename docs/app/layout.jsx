...
export const metadata = {
  ...
  title: {
    default: 'chat-adapter-zaileys — WhatsApp adapter for Chat SDK',
    template: '%s — chat-adapter-zaileys',
  },
  description: DESCRIPTION,
  applicationName: 'chat-adapter-zaileys',
  generator: 'Nextra',
  ...
  openGraph: {
    ...
    locale: 'en_US',
    url: `${SITE_URL}/`,
    siteName: 'chat-adapter-zaileys',
    title: 'chat-adapter-zaileys — WhatsApp adapter for Chat SDK',
    description: DESCRIPTION,
    images: [{ url: logoUrl, width: 512, height: 512, alt: 'chat-adapter-zaileys' }],
  },
  twitter: {
    card: 'summary',
    title: 'chat-adapter-zaileys — WhatsApp adapter for Chat SDK',
  ...
  '@graph': [
    {
      ...
      logo: logoUrl,
      sameAs: [
        'https://github.com/zeative/chat-adapter-zaileys',
        'https://discord.gg/KBHhTTVUc5',
        'https://www.npmjs.com/package/chat-adapter-zaileys',
      ],
    },
    {
      '@type': 'WebSite',
    ...
    },
    {
      ...
      description: DESCRIPTION,
      url: SITE_URL,
      downloadUrl: 'https://www.npmjs.com/package/chat-adapter-zaileys',
...
const navbar = (
  <Navbar
    logo={
      <span style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
        <img src={logoSrc} alt="chat-adapter-zaileys" width={28} height={28} style={{ borderRadius: 6 }} />
        <b>chat-adapter-zaileys</b>
      </span>
    }
    projectLink="https://github.com/zeative/chat-adapter-zaileys"
  ...
  >
    ...
    <a
      href="https://context7.com/zeative/chat-adapter-zaileys"
      target="_blank"
      rel="noreferrer"
    ...
    <a
      href="https://deepwiki.com/zeative/chat-adapter-zaileys"
      target="_blank"
      rel="noreferrer"
      title="Ask DeepWiki"
      style={{ display: 'inline-flex', alignItems: 'center', padding: '0.25rem' }}
...
const FOOTER_COLS = [
  {
    ...
    links: [
      ...
      ['Events & Handlers', `${basePath}/events`],
      ['Message Payload', `${basePath}/payload`],
      ['Cards & Buttons', `${basePath}/cards-buttons`],
    ],
  },
  {
    title: 'Resources',
    links: [
      ...
      ['Message History', `${basePath}/history`],
  ...
  <Footer>
    ...
    <div className="zl-footer">
      <div className="zl-footer-top">
        <div className="zl-footer-brand">
          <a className="zl-footer-logo" href={`${basePath}/`}>
            <img src={logoSrc} alt="chat-adapter-zaileys logo" />
            chat-adapter-zaileys
          </a>
          <p className="zl-footer-tag">
            WhatsApp adapter for Chat SDK, powered by Zaileys — one adapter, the whole WhatsApp surface.
          </p>
          <span className="zl-footer-meta">Runs on Node 20+ · ESM</span>
        </div>
        {FOOTER_COLS.map((col) => (
      ...
      <div className="zl-footer-bottom">
        ...
        <a href="https://github.com/zeative/zaileys" {...newTab}>
          Powered by Zaileys
        </a>
      </div>
    </div>
    ...
    <html lang="en" dir="ltr" suppressHydrationWarning>
      ...
      <body>
        ...
        <Layout
          ...
          docsRepositoryBase="https://github.com/zeative/chat-adapter-zaileys/tree/main/docs"
